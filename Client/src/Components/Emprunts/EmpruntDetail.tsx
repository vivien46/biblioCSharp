    ...
    const fetchData = async () => {
      try {
        ...
        if (error instanceof Error) {
          setError(
            "Impossible de charger les détails de l'emprunt : " + error.message,
          );
        } else {
          setError("Impossible de charger les détails de l'emprunt.");
        }
        setLoading(false);
      }
    };
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td className="px-6 py-4 whitespace-normal break-words max-w-xs">
                {emprunt.livre.titre} (Auteur: {emprunt.livre.auteur}, Éditeur:{" "}
                {emprunt.livre.editeur})
              </td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">
