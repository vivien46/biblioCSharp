...
const UserEditForm: React.FC = () => {
    ...
    const [user, setUser] = React.useState<UserUpdateData>({
        username: '',
        passwordHash: '',
        email: '',
        role: 0,
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorText || "Erreur lors de la mise à jour de l'utilisateur.");
            }

            window.alert("L'utilisateur a été mis à jour avec succès.");
